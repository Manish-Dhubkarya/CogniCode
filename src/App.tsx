  ...
  return (
    <Router basename="/CogniCode_Website">
      <div className="min-h-screen overflow-hidden select-none relative w-screen overflow-x-hidden bg-custom-gradient">
        ...
        <a href='/CogniCode_Website/contactus' className='px-6 py-1 bg-[#131313] cursor-pointer roboto-regular2 font-normal md:text-[20px] text-[15px] rounded-t-[10px] fixed right-4 md:top-100 top-50 translate-x-1/2 z-50 rotate-270'>Contact Us</a>
        <Routes>
