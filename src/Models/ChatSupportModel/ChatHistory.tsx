      ...
      {showHistory && (
        ...
        >
          ...
          <div className="pl-2 py-2 pr-2 border-b bg-gradient-to-r from-blue-500 to-blue-800 rounded-t-2xl border-gray-200 w-full flex justify-between items-center">
            <span className="hover:bg-white/30 hover:backdrop-blur-sm hover:shadow-lg rounded-full p-2 transition-all duration-200"><IoIosArrowBack onClick={() => {setChatSupportOpen(true),setShowHistory(false)}} size={20} /></span> <div className="flex items-center gap-x-1"><div className="text-[16px] font-bold">Chat History</div><span><FaHistory size={20}/></span></div>
            <div
              onClick={() => {
              ...
              className="cursor-pointer hover:bg-white/30 hover:backdrop-blur-sm hover:shadow-lg rounded-full p-2 transition-all duration-200"
            >
              <HiX size={20} />
            </div>
          </div>
